...
router.post('/create', verifyToken, async (req, res) => {
    const { product_name, qty, unit, purchase_price } = req.body;
    ...
    try {
        ...
        await request.query(`
            INSERT INTO [Inventory] (product_name, qty, unit, purchase_price, purchase_date)
            VALUES (@product_name, @qty, @unit, @purchase_price, GETDATE())
        `);
...
router.put('/update/:product_id', verifyToken, async (req, res) => {
    ...
    try {
        ...
        await request.query(`
            UPDATE [Inventory]
            SET product_name = @product_name, qty = @qty, unit = @unit, purchase_price = @purchase_price,purchase_date=getDate()
